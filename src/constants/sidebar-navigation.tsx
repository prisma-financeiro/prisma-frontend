...
import { BiLineChart, BiSpreadsheet } from 'react-icons/bi';
...
export const scrollTo = (ref: MutableRefObject<any>) => ref.current.scrollIntoView({
  behavior: "smooth",
  block: "center",
  inline: "start",
});

export const getSideBarOptionsLanding = (stock: MutableRefObject<any>, marketToday: MutableRefObject<any>): SideBarOption[] => {
  return [
    {
...
export const getSideBarOptionsAssetCompare = (
  valuation: MutableRefObject<any>,
  rentabilidade: MutableRefObject<any>,
  eficiencia: MutableRefObject<any>,
  endividamento: MutableRefObject<any>): SideBarOption[] => {
  return [
    {
      title: 'Indicadores',
      items: [
